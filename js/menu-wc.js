...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">sustenta-commerce documentation</a>
                </li>
                                ...
                                <a href="modules/AppModule.html" data-type="entity-link">AppModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-AppModule-8fc5a558839ae0ccec118f9d7f31152f"' : 'data-target="#xs-components-links-module-AppModule-8fc5a558839ae0ccec118f9d7f31152f"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-AppModule-8fc5a558839ae0ccec118f9d7f31152f"' :
                                            'id="xs-components-links-module-AppModule-8fc5a558839ae0ccec118f9d7f31152f"' }>
                                            <li class="link">
                                            ...
                                            <li class="link">
                                                <a href="components/DoarMaterialComponent.html"
                                                    data-type="entity-link" data-context="sub-entity" data-context-id="modules">DoarMaterialComponent</a>
                                            </li>
                                            <li class="link">
                                            ...
                                            <li class="link">
                                                <a href="components/ProdutosDaCategoriaComponent.html"
                                                    data-type="entity-link" data-context="sub-entity" data-context-id="modules">ProdutosDaCategoriaComponent</a>
                                            </li>
                                            <li class="link">
                                                <a href="components/ProdutosPesquisaComponent.html"
                                                    data-type="entity-link" data-context="sub-entity" data-context-id="modules">ProdutosPesquisaComponent</a>
                                            </li>
                                            <li class="link">
                                            ...
                                            <li class="link">
                                                <a href="components/VisualizarProdutoComponent.html"
                                                    data-type="entity-link" data-context="sub-entity" data-context-id="modules">VisualizarProdutoComponent</a>
                                            </li>
                                        </ul>
                                    </li>
                            </li>
